...
int player_ranks[4] = {-1, -1, -1, -1};  // -1 indicates that the player has not finished
int rank_counter = 0;  // Counter for rank positions
		       //
...
int rank=0;	// rank use in check_game_on function for player winning order	
